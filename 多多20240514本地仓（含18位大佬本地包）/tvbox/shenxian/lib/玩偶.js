{
    ...
    "图片是否需要代理": "否",
    "是否开启获取首页数据": "是",
    "首页推荐链接": "https://api.wogg.xyz",
    "首页列表数组规则": "body&&.module-items",
    "首页片单列表数组规则": ".module-item",
    "首页片单是否Jsoup写法": "1",
    "分类起始页码": "1",
    "分类链接": "https://api.wogg.xyz/index.php/vodshow/{cateId}-{area}-{by}-{class}-{lang}----{catePg}---{year}.html",
    "分类名称": "电影&剧集&综艺&动漫&短剧&音乐",
    "分类名称替换词": "1&2&4&3&6&5",
    "筛选数据": "ext",
    "筛选子分类名称": "",
    "筛选子分类替换词": "*",
    ...
    "分类片单链接加前缀": "https://api.wogg.xyz",
    "分类片单链接加后缀": "",
    "搜索请求头参数": "User-Agent$MOBILE_UA",
    "搜索链接": "https://api.wogg.xyz/index.php/vodsearch/{wd}----------{SearchPg}---.html",
    "POST请求数据": "",
    "搜索截取模式": "1",
    ...
    "简介详情": "'【神仙影视】提醒您：请勿相信影片中的各类广告，以免上当受骗！'+.sqjj_a&&Text",
